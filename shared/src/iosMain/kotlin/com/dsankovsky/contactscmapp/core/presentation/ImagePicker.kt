...
actual class ImagePicker(
    ...
    private val delegate = object : NSObject(), UIImagePickerControllerDelegateProtocol,
        ...
        override fun imagePickerController(
            ...
            val imageNSDate = UIImageJPEGRepresentation(didFinishPickingImage, 1.0) ?: return
            val bytes = ByteArray(imageNSDate.length.toInt())
            memcpy(bytes.refTo(0), imageNSDate.bytes, imageNSDate.length)
            onImagePicked(bytes)
